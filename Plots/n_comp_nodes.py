...
plt.errorbar(alphas, n_comp_avg_rand, np.sqrt(n_comp_avg_rand), fmt='bo-', markersize=5, capsize=5, ecolor="black", label="Random")
plt.errorbar(alphas, n_comp_avg_bc, np.sqrt(n_comp_avg_bc), fmt='rs-', markersize=5, capsize=5, ecolor="black", label="Betweeness Centrality")
plt.errorbar(alphas, n_comp_avg_dg, np.sqrt(n_comp_avg_dg), fmt='g^-', markersize=5, capsize=5, ecolor="black", label="Degree")
plt.errorbar(alphas, n_comp_avg_cl, np.sqrt(n_comp_avg_cl), fmt='m*-', markersize=5, capsize=5, ecolor="black", label="Clustering Coefficient")
...
plt.ylabel(r'\textbf{Final number of components in the network}', fontsize=15)
