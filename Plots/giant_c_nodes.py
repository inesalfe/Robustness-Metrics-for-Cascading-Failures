...
plt.errorbar(alphas, giant_c_avg_bc, np.sqrt(giant_c_var_bc), fmt='rs-', markersize=5, capsize=5, ecolor="black", label="Betweeness Centrality")
plt.errorbar(alphas, giant_c_avg_dg, np.sqrt(giant_c_var_dg), fmt='g^-', markersize=5, capsize=5, ecolor="black", label="Degree")
plt.errorbar(alphas, giant_c_avg_cl, np.sqrt(giant_c_var_cl), fmt='m*-', markersize=5, capsize=5, ecolor="black", label="Clustering Coefficient")
...
plt.ylabel(r'\textbf{N\'/N}', fontsize=15)
